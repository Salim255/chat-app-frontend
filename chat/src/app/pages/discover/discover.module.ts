...
@NgModule({
  ...
  declarations: [DiscoverPage,CardUserComponent, UserInformationComponent, NameAgeComponent, DistanceComponent, WaveComponent, AboutMeComponent, ProfileComponent, LookingForComponent, EssentialsComponent, blockComponent, ReportComponent ]
})
