...
const routes: Routes = [
  {
    ...
    children: [
     ...
     {
      path: 'matches',
      loadChildren: () => import('../features/matches/pages/matches/matches.module').then((m) => m.MatchesPageModule)
     },
     {
      path: 'account',
      loadChildren: () => import('../features/account/pages/account/account.module').then( (m) => m.AccountPageModule)
     }
    ]
  },
  {
  ...
  {
    path: 'edit-profile',
    loadChildren: () => import('../features/account/pages/account/edit-profile/edit-profile.module').then( (m) => m.EditProfilePageModule )
  },
  {
    path: 'settings',
  ...
  {
    path: 'view-profile',
    loadChildren: () => import('../features/profile-viewer/pages/profile-viewer/profile-viewer.module').then((m) => m.ProfileViewerPageModule)
  }
];
